        ...
        >
          ...
          <ul className="mobilevisibleNavItemsUlChild w-[90%]">
            ...
            <li>
              ...
              >
                <HomeOutlined className="text-lg" aria-label="Home" />
            ...
            <li>
              ...
              >
                <FaNewspaper size={18} aria-label="News" />
                <span className="text-xs">ई-पेपर</span>
              </Link>
            </li>
            <li>
              <Link to="/live">
                <PlayCircleOutlined style={{ fontSize: "18px" }} aria-label="Live" />
              </Link>
            </li>

            <li>
              <Link to="/story">
                <MdAutoStories size={18} aria-label="Story" />
              </Link>
            </li>
            <li>
              <Link to="/photos">
            ...
            <li>
              <Link to="/itempage2?newsType=videos">
                <FaPhotoVideo size={18} aria-label="Videos" />
              </Link>
            </li>
            <li
