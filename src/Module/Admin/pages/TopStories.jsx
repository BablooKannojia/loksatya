  ...
  return (
    <>
        ...
        <Col span={24}>
          <Card style={{ minHeight: "80vh", height: "100%" }}>
            <Row gutter={24}>
              ...
              <Col span={6}>
                <Button onClick={showVerifyModal} loading={loading} disabled={loading} type="primary">
                  Preview
                </Button>
              </Col>
            </Row>
      ...
      <Modal
        ...
        footer={[
          <Button key="back" disabled={loading} onClick={handleVerifyCancel}>
            Cancel
          </Button>,
          <Button
            key="schedule"
            ...
            onClick={() => {
              ...
              setPublishAt(scheduleTime);
              if (onEdit) onEditHandle();
              else onUpload();
            }}
            disabled={loading}
          >
